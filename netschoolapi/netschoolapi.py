...
class NetSchoolAPI:
    ...
    async def download_attachment(
        ...
        for attachment in attachments:
            ...
            file.close()
            paths.append(f'/home/greench/mlok/BotData/attachments/{attachment["name"]}')
            print((os.path.abspath(os.path.join(os.path.dirname(__file__), f'BotData/attachments/{attachment["name"]}'))))
        return paths

...
days = {}
data_days = {}
head_p = os.path.abspath(os.path.join(os.path.dirname(__file__), 'BotData/Pics/head_half_year.png'))
pattern_p = os.path.abspath(os.path.join(os.path.dirname(__file__), 'BotData/Pics/pattern.png'))
days_p = os.path.abspath(os.path.join(os.path.dirname(__file__), 'BotData/Pics/days.jpg'))
end_p = os.path.abspath(os.path.join(os.path.dirname(__file__), 'BotData/Pics/end.png'))
